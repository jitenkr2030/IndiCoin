...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock("The Times 03/Jan/2025 - IndiCoin: Controlled Inflation Digital Currency",
                                    ...
                                    1763107813, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Replace with proper IndiCoin genesis hash after mining
        // Temporary: using Bitcoin's genesis until proper mining is complete
