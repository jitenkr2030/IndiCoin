...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock("The Times 14/Nov/2025 - IndiCoin: Controlled Inflation Digital Currency",
                                    ...
                                    1763113202, 0, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // IndiCoin unique genesis block parameters
        assert(consensus.hashGenesisBlock == uint256{"10e870f6ff26921e54f732934d368e495a49e9643d33a6854fe398fa803fabed"});
        assert(genesis.hashMerkleRoot == uint256{"f364e9da90a23b5a6a725e0b976fdd7aadc1531521323d720dbcac9befffb0da"});
